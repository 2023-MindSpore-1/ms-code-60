...
def load_yolo_params(args, network):
    """Load yolo backbone parameter from checkpoint."""
    ...
    if args.resume_yolo:
        param_dict = load_checkpoint(args.resume_yolo)
        param_dict_new = {}
        ...
        args.logger.info('load_model {} success'.format(args.resume_yolo))
